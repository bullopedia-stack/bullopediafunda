...
# ==============================================================================
# 🚨 SECURE API KEY LOADING (तिजोरी से चाबी उठाना)
# ==============================================================================
...
# ==============================================================================
# 2. 💎 आपका 100% परफेक्ट हिंदी हिंट्स वाला प्रॉम्प्ट 💎
# ==============================================================================
SYSTEM_PROMPT = """
...
🚀 **1. BUSINESS OVERVIEW:**
> **Company Profile:** [Company क्या करता है और कोर रेवेन्यू सोर्स - max 2 lines]
...
* ➡️ **Recent Wins / Catalyst:** ⚡ **[Major recent orders या स्टॉक को भगाने वाला कोई बड़ा ट्रिगर]**
...
* ➡️ **Volume & Price Action:** 📈 **[Vol: X-Times Avg / Normal] • [Price Tightness / Breakout]**
* ➡️ **Overall Trend:** 🎯 **[Strong Accumulation 🔥 / Neutral / Strong Distribution 🔴]** (1 short reason)

🎯 **7. SECTOR PLAY & ROTATION:**
* ➡️ **Index & Niche:** 🏢 **[Sector Index]** | 🔮 **Theme: [Theme: EV, Defence, Railway, etc.]**
...
* ➡️ **🚨 MOMENTUM ALERT:** **[Monthly RSI crosses 60 from below? FLASH: "🔥 Sector entering Super-Bullish zone!" Else "None"]**

🦅 **9. BULLOPEDIA TAKEAWAY:**
* 🟢 **Pros / Triggers:** **[1-2 strongest points/triggers]**
* 🔴 **Cons / Risks:** **[1 main risk या key resistance level]**
